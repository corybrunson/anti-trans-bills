...
In order to better see proportions, we also show a stacked bar chart that scaless every $x$-axis group to $100\%$:
...
prop_passed <- prop_passed %>% 
  ...
  tab_header(title = "Bill Passage by Bill Type")
prop_passed
```
...
It appears that 2023 will, indeed, have many anti-trans bills pass than all previous years since 2018 combined (recall that the 2023 data in this analysis only goes through April 2023). What about the *likelihood* of any particular anti-trans bill to pass in 2023 compared to previous years?
