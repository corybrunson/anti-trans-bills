...
The following [mosaic plot](https://haleyjeppson.github.io/ggmosaic/) combines elements (and benefits) of the unscaled and scaled bar plots by mapping each group's share of the total to the width of its stacked bars rather than its height.
